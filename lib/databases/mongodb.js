...
_.extend(Mongo.prototype, {
  ...
  getEvents: function (query, skip, limit, callback) {
    ...
    // allow limiting event stream by event name
    if (query.name) {
      findStatement.name = query.name;
    }
  ...
  getEventsAsStream: function (query) {
    var findStatement = {};
    ...
    return this.events.find(findStatement, { sort: [['commitStamp', 'asc'], ['streamRevision', 'asc'], ['commitSequence', 'asc']] }).stream();
  },
